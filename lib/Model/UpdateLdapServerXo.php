...
class UpdateLdapServerXo implements ModelInterface, ArrayAccess
{
    ...
    public function setConnectionTimeoutSeconds($connection_timeout_seconds)
    {
        ...
        if (($connection_timeout_seconds > 3600)) {
            throw new \InvalidArgumentException('invalid value for $connection_timeout_seconds when calling UpdateLdapServerXo., must be smaller than or equal to 3600.');
        }
        if (($connection_timeout_seconds < 1)) {
            throw new \InvalidArgumentException('invalid value for $connection_timeout_seconds when calling UpdateLdapServerXo., must be bigger than or equal to 1.');
        }
    ...
    public function setConnectionRetryDelaySeconds($connection_retry_delay_seconds)
    {
        ...
        if (($connection_retry_delay_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $connection_retry_delay_seconds when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxIncidentsCount($max_incidents_count)
    {
        ...
        if (($max_incidents_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_incidents_count when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupObjectClass($group_object_class)
    {
        if (!is_null($group_object_class) && (mb_strlen($group_object_class) > 0)) {
            throw new \InvalidArgumentException('invalid length for $group_object_class when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($group_object_class) && (mb_strlen($group_object_class) < 0)) {
            throw new \InvalidArgumentException('invalid length for $group_object_class when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupIdAttribute($group_id_attribute)
    {
        if (!is_null($group_id_attribute) && (mb_strlen($group_id_attribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $group_id_attribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($group_id_attribute) && (mb_strlen($group_id_attribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $group_id_attribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupMemberAttribute($group_member_attribute)
    {
        if (!is_null($group_member_attribute) && (mb_strlen($group_member_attribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $group_member_attribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($group_member_attribute) && (mb_strlen($group_member_attribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $group_member_attribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupMemberFormat($group_member_format)
    {
        if (!is_null($group_member_format) && (mb_strlen($group_member_format) > 0)) {
            throw new \InvalidArgumentException('invalid length for $group_member_format when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($group_member_format) && (mb_strlen($group_member_format) < 0)) {
            throw new \InvalidArgumentException('invalid length for $group_member_format when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
    ...
    public function setUserMemberOfAttribute($user_member_of_attribute)
    {
        if (!is_null($user_member_of_attribute) && (mb_strlen($user_member_of_attribute) > 0)) {
            throw new \InvalidArgumentException('invalid length for $user_member_of_attribute when calling UpdateLdapServerXo., must be smaller than or equal to 0.');
        }
        if (!is_null($user_member_of_attribute) && (mb_strlen($user_member_of_attribute) < 0)) {
            throw new \InvalidArgumentException('invalid length for $user_member_of_attribute when calling UpdateLdapServerXo., must be bigger than or equal to 0.');
        }
