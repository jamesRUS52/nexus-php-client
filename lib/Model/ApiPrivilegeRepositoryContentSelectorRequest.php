...
class ApiPrivilegeRepositoryContentSelectorRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['content_selector'] = isset($data['content_selector']) ? $data['content_selector'] : null;
    }
     ...
     *
     * @param string $content_selector The name of a content selector that will be used to grant access to content via this privilege.
     *
     * @return $this
     */
